...
export const LEXICONS = {
  ...
  violence: [
    ...
    { phrase: 'assault', weight: 0.8 },
    { phrase: 'attack video', weight: 1.8 },
    { phrase: 'attack caught', weight: 1.8 },
    { phrase: 'brutal attack', weight: 2.0 },
    { phrase: 'attack compilation', weight: 2.0 },
    ...
    { phrase: 'caught on camera', weight: 1.0 },
    { phrase: 'caught on video', weight: 1.0 },
    { phrase: 'caught on tape', weight: 1.0 },
